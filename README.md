About nappy-feedstock
=====================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/nappy-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4047&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/nappy-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `nappy` can be installed with `conda`:
...
It is possible to list all of the versions of `nappy` available on your platform with `conda`:
...
```
mamba search nappy --channel conda-forge
```
...
mamba repoquery search nappy --channel conda-forge

# List packages depending on `nappy`:
mamba repoquery whoneeds nappy --channel conda-forge

# List dependencies of `nappy`:
mamba repoquery depends nappy --channel conda-forge
```
